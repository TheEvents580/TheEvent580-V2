...
public class FinderSets {
    ...
    private static final List<Material> villageSet = List.of(Material.BELL, Material.WHITE_BED, Material.HAY_BLOCK, Material.COMPOSTER, Material.BOOKSHELF, Material.BEETROOT_SEEDS, Material.GRINDSTONE, Material.GLASS_PANE, Material.MOSSY_COBBLESTONE);
